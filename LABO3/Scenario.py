...
# Positions des pièces où Cozmo doit se diriger
...
class Scenario:
    ...
    # Chaque fonction Room accompli la même tâche, c'est à dire bouger Cozmo vers une pièce, lui
    # faire observer les marqueurs présents, lui faire poser des questions et envoyer des informations
    # au moteur d'inférence avec les fonctions clause.
    def room1(self, robot: cozmo.robot.Robot, motor):
        ...
        print("Est il vivant")
        #Ici on attend la réponse quand on tape sur le cube
    ...
    # Observer trois marqueurs, et permet d'identifier quelle arme, pokemon et pièce cozmo voit
    ...
    #Ajoute les marqueurs au monde magique de Cozmo
    ...
    # Permet de créer une nouvelle clause selon les informations et la sémantique selon le
    # format offert par les fichiers respectifs retrouvés dans le fichier grammars
